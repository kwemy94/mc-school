          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit a session</h3>
              ...
              <form action="{{url('session/update/'.$sessions->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
              
                <div class="form-group">
                    <label for="inputClientCompany">Numero Session</label>
                    <input type="text" name="numero_session" id="inputClientCompany" class="form-control" placeholder="Nom Module" value="{{
                        $sessions->numero_session }}">
                ...
                <div class="form-group">
                  ...
                  <input type="date" id="dataDebut" name="date_debut" value="{{$sessions->date_debut}}">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="dateFin" name="date_fin" value="{{$sessions->date_fin}}">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <input type="submit" value="Update session" class="btn btn-success float-right">
                </div>
              </div>
            </form>
              <!-- /.card-body -->
